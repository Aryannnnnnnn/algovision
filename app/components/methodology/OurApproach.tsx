  ...
  const pillars = [
    {
      ...
      description: "Every decision starts with data. We analyze market trends, customer behavior, and competitive landscapes to build strategies on solid ground."
    },
    {
      icon: (
        <svg className="w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      description: "Machine learning algorithms uncover patterns humans miss, predicting outcomes and optimizing campaigns in real-time."
    },
    {
      icon: (
        <svg className="w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      description: "Marketing isn't set-it-and-forget-it. We continuously test, learn, and refine to maximize performance at every stage."
    },
    {
      icon: (
        <svg className="w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      description: "Your team knows your business best. We work alongside you, not in a silo, ensuring alignment at every step."
    },
  ];
      ...
      <div className="relative xl:max-w-[95vw] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div ref={headingRef} className="mb-16">
          ...
          <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mb-4">
            Our methodology isn't theoretical—it's battle-tested across hundreds of campaigns and billions in ad spend.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          {pillars.map((pillar, index) => (
            <div key={index} className="approach-pillar space-y-6">
              {/* Icon */}
