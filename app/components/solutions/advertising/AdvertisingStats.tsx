...
export default function AdvertisingStats() {
  ...
  const stats = [
    {
      value: "15+",
      label: "Platforms",
      description: "Integrated advertising platforms",
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      value: "95%",
      label: "Reach",
      description: "Average audience reach increase",
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      value: "3.5x",
    ...
    },
    {
      value: "$10M+",
      label: "Ad Spend",
      description: "Managed monthly across platforms",
      gradient: "from-blue-500 to-cyan-500",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl">
            Real results from advertising campaigns across industries
          </p>
        </div>
