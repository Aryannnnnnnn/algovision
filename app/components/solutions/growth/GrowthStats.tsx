...
export default function GrowthStats() {
  ...
  const stats = [
    ...
    },
    {
      value: "42%",
      label: "Open Rate",
      description: "Average email open rate vs 21% industry standard",
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      value: "5+",
      label: "Channels",
      description: "Unified multi-channel campaigns",
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      value: "85%",
      label: "Engagement",
      description: "Customer engagement rate across touchpoints",
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      value: "2.8x",
    ...
    },
    {
      value: "10M+",
      label: "Messages",
      description: "Sent monthly across all platforms",
      gradient: "from-blue-500 to-cyan-500",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl">
            Real results from growth campaigns across industries
          </p>
        </div>
