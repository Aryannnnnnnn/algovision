...
const serviceCategories = [
  {
    ...
    href: "/solutions/ai-chatbots/chatbot",
  ...
  },
  {
    ...
    features: ["Crisis Management", "Brand Monitoring", "Media Relations"],
    stats: [
    ...
    href: "/solutions/pr-communications/magazines",
  ...
  },
  {
    ...
    href: "/solutions/omnichannel-advertising/google-ads",
  ...
  },
  {
    ...
    href: "/solutions/growth-performance-marketing/search-engine-blogs",
...
export default function ServiceSelection() {
  ...
  return (
    <section id="services" ref={sectionRef} className="relative py-20 sm:py-24 lg:py-32 bg-gradient-to-br from-gray-50 via-white to-gray-50 overflow-hidden">
      {/* Grid Pattern */}
