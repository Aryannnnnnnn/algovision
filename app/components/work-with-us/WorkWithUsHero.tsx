        ...
        <div className="max-w-5xl">
          <div ref={contentRef} className="space-y-6 md:space-y-8">
            ...
            <div className="inline-flex items-center px-3 py-1.5 bg-[#1e293b] rounded-full shadow-lg">
              <span className="text-xs font-bold text-white">Start Your Journey</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl">
              Partner with Algo Vision to unlock exponential growth. Our AI-powered marketing solutions have helped 100+ brands achieve 3.2x faster growth than industry average.
            </p>
