  ...
  const stats = [
    {
      ...
      description: "Average query resolution without human intervention",
    ...
    },
    {
      ...
      description: "Average CSAT score across deployments",
      gradient: "from-emerald-500 to-blue-500",
    },
    {
      value: "10M+",
      label: "Conversations",
      description: "Processed monthly across all clients",
