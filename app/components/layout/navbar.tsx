        ...
        <div className="flex items-center justify-between h-[72px]">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="relative">
              <div className="w-9 h-9 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-lg flex items-center justify-center shadow-sm transition-all duration-300 group-hover:shadow-md group-hover:shadow-orange-500/20">
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            <Link href="/" className="px-3.5 py-2 text-[15px] text-gray-700 hover:text-gray-900 font-medium transition-colors duration-150 relative group">
              Home
              <span className="absolute inset-x-3 -bottom-px h-0.5 bg-orange-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-200 origin-center rounded-full"></span>
            </Link>
            ...
            >
              <button className={`px-3.5 py-2 text-[15px] text-gray-700 hover:text-gray-900 font-medium flex items-center gap-1 transition-colors duration-150 relative group ${activeDropdown === "solutions" ? "text-gray-900" : ""}`}>
                ...
                <span className={`absolute inset-x-3 -bottom-px h-0.5 bg-orange-600 transition-transform duration-200 origin-center rounded-full ${activeDropdown === "solutions" ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"}`}></span>
              </button>
                            ...
                            {navbarData.solutions.categories.map((category, idx) => (
                              ...
                              >
                                <div className={`w-1.5 h-1.5 rounded-full ${
                                  activeCategory === idx ? "bg-orange-600" : "bg-gray-400"
                                }`}></div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          {navbarData.solutions.categories[activeCategory].links.map((link) => (
                            <Link
                              key={link.href}
                              href={link.href}
                              className="group flex items-start gap-3 p-3 rounded-lg hover:bg-orange-50/50 transition-all duration-300"
                            >
                              <div className="flex-shrink-0 w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-orange-100 transition-colors duration-300">
                                <svg className="w-5 h-5 text-gray-600 group-hover:text-orange-600 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                  <path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                                </svg>
                              </div>
                              <div className="flex-1 min-w-0">
                                <div className="text-sm font-semibold text-gray-900 group-hover:text-orange-600 transition-colors duration-300 mb-0.5">
                                  {link.name}
                                </div>
            ...
            >
              <button className={`px-3.5 py-2 text-[15px] text-gray-700 hover:text-gray-900 font-medium flex items-center gap-1 transition-colors duration-150 relative group ${activeDropdown === "company" ? "text-gray-900" : ""}`}>
                ...
                <span className={`absolute inset-x-3 -bottom-px h-0.5 bg-orange-600 transition-transform duration-200 origin-center rounded-full ${activeDropdown === "company" ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"}`}></span>
              </button>
            ...
            >
              <button className={`px-3.5 py-2 text-[15px] text-gray-700 hover:text-gray-900 font-medium flex items-center gap-1 transition-colors duration-150 relative group ${activeDropdown === "resources" ? "text-gray-900" : ""}`}>
                ...
                <span className={`absolute inset-x-3 -bottom-px h-0.5 bg-orange-600 transition-transform duration-200 origin-center rounded-full ${activeDropdown === "resources" ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"}`}></span>
              </button>
            ...
            >
              <button className={`px-3.5 py-2 text-[15px] text-gray-700 hover:text-gray-900 font-medium flex items-center gap-1 transition-colors duration-150 relative group ${activeDropdown === "connect" ? "text-gray-900" : ""}`}>
                ...
                <span className={`absolute inset-x-3 -bottom-px h-0.5 bg-orange-600 transition-transform duration-200 origin-center rounded-full ${activeDropdown === "connect" ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"}`}></span>
              </button>
            ...
            {/* Blog - Standalone */}
            <Link href="/resources/blogs" className="px-3.5 py-2 text-[15px] text-gray-700 hover:text-gray-900 font-medium transition-colors duration-150 relative group">
              Blog
              <span className="absolute inset-x-3 -bottom-px h-0.5 bg-orange-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-200 origin-center rounded-full"></span>
            </Link>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 bg-white lg:hidden z-[100] flex flex-col h-screen w-screen">
          ...
          <div className="flex-shrink-0 bg-white border-b border-gray-200 shadow-sm">
            <div className="flex justify-between items-center p-4">
              <Link href="/" className="flex items-center gap-2.5" onClick={() => setMobileMenuOpen(false)}>
                <div className="w-8 h-8 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-lg flex items-center justify-center">
          ...
          <div className="flex-1 overflow-y-auto p-4">
            ...
            <Link
              href="/"
              className="block px-4 py-3 text-gray-900 hover:bg-orange-50 hover:text-orange-600 rounded-lg font-medium transition-colors mb-1"
              onClick={() => setMobileMenuOpen(false)}
            >
              Home
            </Link>
            ...
            <div className="mb-1">
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 text-gray-900 hover:bg-orange-50 rounded-lg font-medium transition-colors"
              >
                <span>Solutions</span>
                ...
                <div className="pl-2 pr-2 py-2 space-y-4">
                  {navbarData.solutions.categories.map((category) => (
                    <div key={category.title}>
                      {/* Category Title */}
                      <div className="px-4 py-1.5 text-xs font-bold text-orange-600 uppercase tracking-wider">
                        {category.title}
                      </div>
                      {/* Category Links */}
